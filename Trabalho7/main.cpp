...
int main() {
    ...
    // CORREÇÃO: Usar CreateInstance em vez de GetInstance com parâmetros
    auto& grid = Grid::CreateInstance(numCols, numRows, cellSize);
    auto& agentManager = AgentManager::CreateInstance(&grid);
