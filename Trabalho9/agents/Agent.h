...
public:
    static constexpr float DEFAULT_BROAD_RADIUS = 15.0f;
    static constexpr float DEFAULT_COLLISION_RADIUS = 8.0f;
    ...
    float getBroadRadius() const { return broadRadius; }
    
    float getCollisionRadius() const { return collRadius; }
